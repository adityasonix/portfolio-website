    ...
    return (
        <button className="cursor-pointer"> 
            <a href={routeOption.link}>
                <div className="animate-rotate-border hover:animate-rotate-border-hover ease-in-out bg-conic/[from_var(--home-border-angle)] from-slate-900 via-slate-500 to-slate-900 p-[3px] rounded-2xl">

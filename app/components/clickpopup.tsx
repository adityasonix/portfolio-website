...
const ClickPopup = () => {
    ...
    return (
        <>
            {showPopup && (
                <div className="absolute z-0 top-1/6 sm:top-1/12 left-1/2 -translate-x-1/2 bg-slate-600 text-white text-base px-3 py-1 border-2 border-slate-900 rounded-full shadow-lg animate-fade-in">
